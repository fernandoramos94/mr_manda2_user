(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-category-category-module"], {
    ...
    function FTWP(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_components_menu_menu_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/components/menu/menu.component */
      "0oYm");
      /* harmony import */


      var _variations_variations_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var CategoryPage = /*#__PURE__*/function () {
        ...
        _createClass(CategoryPage, [{
          ...
          value: function changeFilters() {
            var raw = this.foods;
            var value = this.searchByProduct.trim().toLowerCase();
            var newData = raw.filter(function (item) {
          ...
          value: function getFoodByCid() {
            ...
            this.api.post('products/getFoodByCid', param).then(function (data) {
              ...
              if (data && data.status === 200 && data.data.length > 0) {
                ...
                _this4.filteredProducts = _this4.foods;
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.alertController.create({
                        ...
                        message: this.util.translate("Ya tienes art\xEDculos en el carrito con un restaurante diferente"),
                        buttons: [{
          ...
          value: function category() {
            ...
            this.api.post('categories/getByRestId', param).then(function (data) {
              if (data && data.status === 200 && data.data.length) {
                ...
                _this9.caetId = _this9.categories[0].id;
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], src_app_services_apis_service__WEBPACK_IMPORTED_MODULE_6__["ApisService"], src_app_services_util_service__WEBPACK_IMPORTED_MODULE_7__["UtilService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["PopoverController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"], src_app_services_cart_service__WEBPACK_IMPORTED_MODULE_10__["CartService"], _angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"]])], CategoryPage);
      /***/
    },

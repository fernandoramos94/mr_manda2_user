    ...
    function ARc(module, __webpack_exports__, __webpack_require__) {
      ...
      var RatePage = /*#__PURE__*/function () {
        function RatePage(api, util, navCtrl, router, modalCtrl) {
          ...
          this.router = router;
          this.modalCtrl = modalCtrl; // console.log(this.util.orderDetails);

          if (this.util.orderDetails && this.util.orderDetails.orders) {
            this.products = JSON.parse(this.util.orderDetails.orders); // console.log(this.products);
          } else {

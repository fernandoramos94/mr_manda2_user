  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function yHma(module, __webpack_exports__, __webpack_require__) {
      ...
      var LocationService = /*#__PURE__*/function () {
        function LocationService(androidPermissions, locationAccuracy, gelocation) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return new Promise(function (resolve, reject) {
                        _this2.locationAccuracy.canRequest().then(function (canRequest) {
                          if (canRequest) {
                            resolve('CAN_REQUEST');
                          } else {
                            // Show 'GPS Permission Request' dialogue
                            _this2.androidPermissions.requestPermission(_this2.androidPermissions.PERMISSION.ACCESS_COARSE_LOCATION).then(function (result) {
                              if (result.hasPermission) {
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return new Promise(function (resolve, reject) {
                        _this4.gelocation.getCurrentPosition().then(function (resp) {
                          var geo = {
      ...
      LocationService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_2__["AndroidPermissions"], _ionic_native_location_accuracy_ngx__WEBPACK_IMPORTED_MODULE_4__["LocationAccuracy"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_3__["Geolocation"]])], LocationService);
      /***/
    }
  }]);
})();

        ...
        _createClass(HistoryDetailPage, [{
          ...
          value: function getOrder() {
            ...
            this.api.post('orders/getById', param).then(function (datas) {
              _this2.loaded = true; // console.log(datas);
              ...
              if (datas && datas.status === 200 && datas.data.length) {
                ...
                _this2.restFCM = data.str_fcm_token; // console.log("FCM RESTAURANTEEE", this.restFCM)
          ...
          value: function getDriverInfo() {
            ...
            this.api.post('drivers/getById', param).then(function (data) {
              ...
              if (data && data.status === 200 && data.data.length) {
                ...
                _this4.util.orderDetails['driverInfo'] = info; // console.log('---->>>>>', info);

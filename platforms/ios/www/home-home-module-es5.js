    ...
    function hsj(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        ...
        _createClass(HomePage, [{
          ...
          key: "onFocusEvent",
          value: function onFocusEvent(event) {
            this.router.navigate(['buscador', {
              useFocusOnSearch: true
            }]);
          }
        }, {
          key: "onBlurEvent",
          ...
          key: "bebidas",
          value: function bebidas() {
            this.router.navigate(['bebidas']);
          }
        }, {
          key: "comida",
          value: function comida() {
            this.router.navigate(['comida']);
          }
        }, {
          key: "conveniencia",
          value: function conveniencia() {
            this.router.navigate(['conveniencia']);
          }
        }, {
          key: "hogaryferreteria",
          value: function hogaryferreteria() {
            this.router.navigate(['hogaryferreteria']);
          }
        }, {
          key: "cafeypan",
          value: function cafeypan() {
            this.router.navigate(['cafeypan']);
          }
        }, {
          key: "supermercado",
          value: function supermercado() {
            this.router.navigate(['supermercado']);
          }
        }, {
          key: "salud",
          value: function salud() {
